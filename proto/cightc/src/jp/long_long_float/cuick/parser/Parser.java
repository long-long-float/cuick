    ...
    StmtNode stmt;
      ...
      while (true) {
        ...
        if (jj_2_1(2147483647)) {
          deffun = deffun();
                          decls.addDeffun(deffun);
        } else if (jj_2_2(2147483647)) {
          deffun = def_extendfun();
                                 decls.addDeffun(deffun);
...
//変数宣�?
  ...
  final public DefinedFunction deffun() throws ParseException {
    ...
    BlockNode body;
      ...
      jj_consume_token(97);
      body = block();
            //TypeNode t = new FunctionType(ret, ps.parametersType());
            //return new DefinedFunction(new TypeNode(t), n, ps, body);
            {if (true) return new Function(ret, n, ps, body);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("deffun");
    }
  ...
  final public DefinedFunction def_extendfun() throws ParseException {
    ...
    BlockNode body;
      ...
      jj_consume_token(97);
      body = block();
            if(receiver) ps.addParamFront(receiver);
            TypeNode t = new FunctionType(ret, ps.parametersType());
...
*/
  final public TypeNode type() throws ParseException {
    ...
    TypeNode type;
    List<TypeNode> templ_types = null;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case DOLLAR:
        t = jj_consume_token(DOLLAR);
        name = name();
    {if (true) return new TemplateType(location(t), name);}
        break;
      case CHAR:
      case INT:
      case LONG:
...
$T*
*/
  final public TypeNode type_with_suffix() throws ParseException {
  ...
  final public TypeNode type_base() throws ParseException {
    ...
    TypeNode templ_type;
      ...
      case VOID:
        t = jj_consume_token(VOID);
                          {if (true) return new VoidType(location(t));}
        break;
      case CHAR:
        t = jj_consume_token(CHAR);
                          {if (true) return IntegerType.charType(location(t));}
        break;
      case SHORT:
        t = jj_consume_token(SHORT);
                          {if (true) return IntegerType.shortType(location(t));}
        break;
      case INT:
        t = jj_consume_token(INT);
                          {if (true) return IntegerType.intType(location(t));}
        break;
      case LONG:
        t = jj_consume_token(LONG);
                          {if (true) return IntegerType.longType(location(t));}
        break;
      default:
        jj_la1[28] = jj_gen;
        if (jj_2_5(2)) {
          ...
          {if (true) return IntegerType.ucharType(location(t));}
        } else if (jj_2_6(2)) {
          t = jj_consume_token(UNSIGNED);
          jj_consume_token(SHORT);
          {if (true) return IntegerType.ushortType(location(t));}
        } else if (jj_2_7(2)) {
          t = jj_consume_token(UNSIGNED);
          jj_consume_token(INT);
          {if (true) return IntegerType.uintType(location(t));}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case UNSIGNED:
            t = jj_consume_token(UNSIGNED);
            jj_consume_token(LONG);
          {if (true) return IntegerType.ulongType(location(t));}
            break;
          case STRUCT:
            t = jj_consume_token(STRUCT);
            name = jj_consume_token(IDENTIFIER);
          {if (true) return new StructType(location(t), name.image);}
            break;
          case UNION:
            t = jj_consume_token(UNION);
            name = jj_consume_token(IDENTIFIER);
          {if (true) return new UnionType(location(t), name.image);}
            break;
          case IDENTIFIER:
            /*LOOKAHEAD({isType(getToken(1).image)})*/ name = jj_consume_token(IDENTIFIER);
          {if (true) return new UserType(location(nameType.image));}
            break;
          default:
            jj_la1[29] = jj_gen;
            jj_consume_token(-1);
  ...
  final public ForEachNode foreach_stmt() throws ParseException {
    ...
    StmtNode body, lastBody = null;
      ...
      var_type = type();
      var_name = name();
                                          foreVars.add(var_type, var_name);
      label_10:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 95:
      ...
      default:
        ...
        ;
            ...
            {if (true) return new ForEachNode(foreVars, dire, foreEnumes, body, lastBody);}
    throw new Error("Missing return statement in function");
    } finally {
      ...
      if (jj_2_10(2147483647)) {
        ...
        while (true) {
          ...
          default:
            ...
            {if (true) return new VariableSetEnumerable(evs);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case SIZEOF:
        case IDENTIFIER:
        ...
        case 132:
          expr = expr();
            {if (true) return new VariableEnumerable(expr);}
          break;
        default:
          jj_la1[42] = jj_gen;
          jj_consume_token(-1);
  ...
  final public MultiplexAssignNode multiplex_assign() throws ParseException {
    ...
    List<ExprNode> rhses = new ArrayList<ExprNode>();
      ...
      jj_consume_token(96);
            {if (true) return new MultiplexAssignNode(location(t), lhses, rhses);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  final public List<TypeNode> templ_types() throws ParseException {
      ...
      case STRING:
        t = jj_consume_token(STRING);
            {if (true) return new StringLiteralNode(location(t),
                                    new PointerType(IntegerType.charRef()),
                                    stringValue(t.image));}
        break;
      case IDENTIFIER:
        t = jj_consume_token(IDENTIFIER);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x20091200,0x20090200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20091200,0x20090200,0x0,0x0,0x0,0x0,0x0,0x1000,0x0,0x0,0x1000,0x0,0x0,0x80000,0x20010200,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x20000,0x400,0x20090200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xc832c015,0x8224001,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x20000,0x0,0xc032c015,0x224001,0x0,0x0,0x20000,0x0,0x0,0xc0108014,0x0,0x0,0x8014,0xc0100000,0x0,0x20001,0x204000,0x0,0x20000,0x20000,0x20000,0x0,0x0,0x0,0x8,0x0,0x20000,0x0,0x0,0x0,0x224001,0x4000,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x20000,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xd0843e4,0xd084320,0x4000000,0x8000000,0xd084300,0x10000000,0x40000000,0x80000000,0x4000000,0x8000000,0xd084300,0x10000000,0x40000000,0x80000000,0x4000000,0x8000000,0xd084300,0x10000000,0xd084364,0xd084320,0x4000000,0x8000000,0xd084300,0x10000000,0x0,0x144,0x4000000,0x8000000,0x4,0x100,0x0,0xd084320,0x0,0x0,0xd084300,0xd084300,0xd084300,0x80000000,0x0,0x0,0x0,0x80000000,0xd084300,0x0,0x0,0x0,0xd084320,0x0,0x80000000,0x80000000,0xd084300,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000000,0x8000000,0x8000000,0xd084300,0xc000000,0x1084300,0x13000000,0x0,0x13000000,0x80000000,0x80000000,0xd084300,0x1084300,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x60000005,0x60000005,0x0,0x0,0x60000000,0x0,0x0,0x0,0x0,0x0,0x60000000,0x0,0x0,0x0,0x0,0x0,0x60000000,0x0,0x60000005,0x60000005,0x0,0x0,0x60000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x60000004,0x0,0x0,0x60000000,0x60000000,0x60000000,0x0,0x60,0x60,0x0,0x0,0x60000000,0x0,0x0,0x0,0x60000005,0x0,0x0,0x0,0x60000000,0x3ff80,0x40000,0x80000,0x100000,0x1e00060,0x1e00060,0x2000000,0x4000000,0x18000000,0x18000000,0x60000000,0x60000000,0x80000000,0x80000000,0x0,0x60000000,0x60000000,0x0,0x0,0x0,0x0,0x0,0x0,0x60000000,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x1e,0x1e,0x0,0x0,0x1e,0x0,0x0,0x0,0x0,0x0,0x1e,0x0,0x0,0x0,0x0,0x0,0x1e,0x0,0x1e,0x1e,0x0,0x0,0x1e,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x1e,0x0,0x0,0x1e,0x1e,0x1e,0x0,0x0,0x0,0x0,0x0,0x1e,0x0,0x0,0x0,0x1e,0x0,0x0,0x0,0x1e,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x1e,0x1e,0x0,0x66,0x40,0x66,0x0,0x0,0x1e,0x0,0x300,};
   }
